            ...
            <%
                ...
                <div class="col-md-6">
                   <div class="form-group">
                      <label for="exampleInputEmail1">Theater owner name</label>
            ...
            %>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                          <label  for="exampleInputPassword1">Number</label><br>
                    ...
                    <label for="exampleInputEmail1">Select Your Theater Screen type </label>
                      <div class="radio">
                        <label>
                                   ...
                                   <div class="box-body">
                                       <div class="row">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-xs-3">
                                                <label for="exampleInputEmail1">Name of Screen</label>
                                                <input type="text" class="form-control" id="s_name4" name="s4_name" placeholder="Screen Name like Audi3">
                                            </div>
                                            <div class="col-xs-4">
                                                <label for="exampleInputEmail1">Seat Capacity</label>
                                            ...
                                            <div class="col-xs-5">
                                                <label for="exampleInputEmail1">Screen Number</label>
                                                <input type="number" class="form-control" id="s_num4" name="s4_number" placeholder="Searial Number of scree" value="3">
                                            </div>
                                        </div><!-- /.row -->
                                        <div class="row">
                                            <div class="box-header with-border">
                                           ...
                                           <div class="col-xs-3">
                                                <label for="exampleInputEmail1">Name of Screen</label>
                                                <input type="text" class="form-control" id="s_name5" name="s5_name" placeholder="Screen Name like Audi3">
                                            </div>
                                            <div class="col-xs-4">
                                                <label for="exampleInputEmail1">Seat Capacity</label>
                                            ...
                                            <div class="col-xs-5">
                                                <label for="exampleInputEmail1">Screen Number</label>
                                                <input type="number" class="form-control" id="s_num5" name="s5_number" placeholder="Searial Number of scree" value="3">
                                            </div>
                                        </div><!-- /.row -->
                                        <div class="row">
                                            <div class="box-header with-border">
                                          ...
                                          <div class="col-xs-3">
                                                <label for="exampleInputEmail1">Name of Screen</label>
                                                <input type="text" class="form-control" id="s_name6" name="s6_name" placeholder="Screen Name like Audi3">
                                            </div>
                                            <div class="col-xs-4">
                                                <label for="exampleInputEmail1">Seat Capacity</label>
                                            ...
                                            <div class="col-xs-5">
                                                <label for="exampleInputEmail1">Screen Number</label>
                                                <input type="number" class="form-control" id="s_num6" name="s6_number" placeholder="Searial Number of scree" value="3">
                                            </div>
                                        </div><!-- /.row -->
                                   ...
                                   <div class="box-body">
                                       <div class="row">
                                           <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">Name of Screen</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" name="ss_name" placeholder="Party Name">
                                             </div>
